...
1. Upload the entire `/team-members-for-elementor` directory to the `/wp-content/plugins/` directory.
2. Activate Team Members for Elementor through the 'Plugins' menu in WordPress.
